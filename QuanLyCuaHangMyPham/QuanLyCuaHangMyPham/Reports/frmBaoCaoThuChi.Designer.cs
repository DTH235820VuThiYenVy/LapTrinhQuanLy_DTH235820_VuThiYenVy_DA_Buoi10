namespace QuanLyCuaHangMyPham.Reports
{
    partial class frmBaoCaoThuChi
    {
        ...
        private void InitializeComponent()
        {
            ...
            // reportViewer1
            // 
            reportViewer1.Location = new Point(12, 168);
            reportViewer1.Name = "reportViewer1";
            reportViewer1.ServerReport.BearerToken = null;
            reportViewer1.Size = new Size(1092, 338);
            ...
            groupBox1.Controls.Add(cboNoiDung);
            ...
            // cboNoiDung
            // 
            cboNoiDung.FormattingEnabled = true;
            cboNoiDung.Items.AddRange(new object[] { "" });
            cboNoiDung.Location = new Point(590, 87);
            cboNoiDung.Name = "cboNoiDung";
            cboNoiDung.Size = new Size(240, 31);
            cboNoiDung.TabIndex = 68;
            // 
            // label3
            // 
            ...
            Name = "frmBaoCaoThuChi";
            StartPosition = FormStartPosition.CenterScreen;
            Text = "Báo cáo thu chi";
            Load += frmBaoCaoThuChi_Load;
